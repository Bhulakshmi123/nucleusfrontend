...
class BusinessMCard extends Component {
    ...
    urlFunction = () => {
        let urlFormat = this.props.match.path.split('/');
        let dataPacket = urlFormat[urlFormat.length - 1] + 'Projects';
        console.log('Cnosole', dataPacket);
        // this.setState({ data: { dataPacket } })
    }
    render() {
        {this.urlFunction()}
        return (
