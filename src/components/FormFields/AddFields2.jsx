        ...
        return (
            <React.Fragment>
                ...
                <Form.Row className="mt-3">
                    <Col md={3}>
                        <SelectInput name="equip_type" cStyle="widthone" label="Equipment Type" placeholder="Select Equipment Type" defaultValue={this.props.formData.leadDet_modal} ></SelectInput>
                    </Col>
                    <Col md={3}>
                        <SelectInput name="selct_make" cStyle="widthone" label="Make" placeholder="Select Make" defaultValue={this.props.formData.leadDet_make} ></SelectInput>
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupPhno">
                            <Form.Label className="ml-1">Model</Form.Label>
                            <Form.Control name="equip_modal" placeholder="Equipment Modal" defaultValue={this.props.formData.leadDet_modal}/>
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <SelectInput name="min_year" cStyle="widthone" label="Minimum Year" placeholder="Select Minimum Year" defaultValue={this.props.min_year}></SelectInput>
                    </Col>
                </Form.Row>
                <Form.Row className="mt-3">
                    <Col md={3}>
                        <Form.Group controlId="formGroupCapty">
                            ...
                            <Form.Control name="capacity" placeholder="Capacity of Equipment" defaultValue={this.props.formData.leadDet_capacity} />
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupJob">
                            <Form.Label className="ml-1">Job Location</Form.Label>
                            <Form.Control name="job_loc" placeholder="Location of Work" className=" text-capitalize" defaultValue={this.props.formData.leadDet_location} />
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <CalenderInput name="extd_start_dte" label="Expected Start Date*" placeholder="Expected Start Date" defaultValue={this.props.formData.leadDet_startDate} />
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupMoth">
                            <Form.Label className="ml-1">No. of months</Form.Label>
                            <Form.Control name="no_month" placeholder="Duration of Work" defaultValue={this.props.no_month}/>
                        </Form.Group>
                    </Col>
                </Form.Row>
                <Form.Row className="mt-3">
                    <Col md={3}>
                        <SelectInput name="state" cStyle="widthone" label="State" placeholder="Select State" defaultValue={this.props.state}></SelectInput>
                    </Col>
                    <Col md={3}>
                        <SelectInput name="district_nm" cStyle="widthone" label="District / Known Area" placeholder="Select District or State" defaultValue={this.props.district_nm}></SelectInput>
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupprStage">
                            <Form.Label className="ml-1">Project Stage</Form.Label>
                            <Form.Control name="project_nm" placeholder="Stage of Project" defaultValue={this.props.formData.leadDet_operatorFood} />
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupHD">
                            <Form.Label className="ml-1">Operation hours per day</Form.Label>
                            <Form.Control name="operation_hours" placeholder="Operation hours per day" defaultValue={this.props.formData.leadDet_workingHoursPerDay} />
                        </Form.Group>
                    </Col>
                </Form.Row>
                <Form.Row className="mt-3">
                    <Col md={3}>
                        <Form.Group controlId="formGroupPM">
                            ...
                            <Form.Control name="operation_d_m" placeholder="Operation days per month" defaultValue={this.props.formData.leadDet_workingTotalCount} />
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupQty">
                            <Form.Label className="ml-1">Quantity</Form.Label>
                            <Form.Control name="quantity" placeholder="Quantity" defaultValue={this.props.formData.leadDet_quantity}/>
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupHM">
                            <Form.Label className="ml-1">Operation hours per month</Form.Label>
                            <Form.Control name="operation_h_m" placeholder="Operation hours per month" defaultValue={this.props.formData.leadDet_operatorBatha}/>
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <Form.Group controlId="formGroupTOW">
                            <Form.Label className="ml-1">Type of Work</Form.Label>
                            <Form.Control name="type_of_work" placeholder="Type of Work" defaultValue={this.props.formData.leadDet_workingUnits}/>
                        </Form.Group>
                    </Col>
                </Form.Row>
                <Form.Row className="mt-3">
