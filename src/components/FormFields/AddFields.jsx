    ...
    render() {
        ...
        <React.Fragment>
            ...
            <Form.Row className="mt-3">
                <Col md={3}><SelectInputSearch name="equip_type" cStyle="widthone" label="Equipment Type *" placeholder="Select Equipment Type" value={this.state.equipmentForm.equip_type || ''} onChange={this.props.equipInputChangeHandlerSelect} isopen={this.state.isOpenFormDropDown} options={this.state.optionsForm3}></SelectInputSearch></Col>
                <Col md={3}><Form.Group controlId="formGroupmod"><Form.Label className="font_stle">Make</Form.Label><Form.Control type="text" name="selct_make" placeholder="Select Make" value={this.state.equipmentForm.selct_make || ''} onChange={this.props.equipInputChangeHandler}/></Form.Group>
                </Col>
                ...
                <Col md={3}><SelectInputSearch name="min_year" cStyle="widthone" label="Minimum Year" placeholder="Select Minimum Year" value={this.state.equipmentForm.min_year || ''} onChange={this.props.equipInputChangeHandler} isopen={this.state.isOpenFormDropDown} options={this.state.optionsForm4}></SelectInputSearch></Col>
            </Form.Row>
            <Form.Row className="mt-3">
            ...
            <Form.Row className="mt-3">
                <Col md={3}><SelectInputSearch name="state" cStyle="widthone" label="State" placeholder="Select State" value={this.state.equipmentForm.state || ''} onChange={this.props.equipInputChangeHandler} isopen={this.state.isOpenFormDropDown} options={this.state.optionsForm5}></SelectInputSearch></Col>
                <Col md={3}><SelectInputSearch name="district_nm" cStyle="widthone" label="District / Known Area" placeholder="Select District or State" value={this.state.equipmentForm.district_nm || ''} onChange={this.props.equipInputChangeHandler} isopen={this.state.isOpenFormDropDown} options={this.state.optionsForm6}></SelectInputSearch></Col>
