import { GET_EQUIPMENT_SUPPLIER_LIST, GET_LEADS_NEW, GET_LEADS_ACTIVE, GET_LEADS_PENDING, GET_LEADS_REJECTED, GET_LEAD_INFORMATION, GET_LEAD_EQUIPMENT_DETAILS } from './actionTypes';
